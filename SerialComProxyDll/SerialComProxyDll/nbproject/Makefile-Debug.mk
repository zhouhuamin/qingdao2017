...
LDLIBSOPTIONS=/usr/local/lib/libcrypto.so.1.1 /usr/local/lib/libssl.so.1.1

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /usr/lib/libSerialComProxyDll.${CND_DLIB_EXT}

/usr/lib/libSerialComProxyDll.${CND_DLIB_EXT}: /usr/local/lib/libcrypto.so.1.1

/usr/lib/libSerialComProxyDll.${CND_DLIB_EXT}: /usr/local/lib/libssl.so.1.1

/usr/lib/libSerialComProxyDll.${CND_DLIB_EXT}: ${OBJECTFILES}
	${MKDIR} -p /usr/lib
	${LINK.cc} -o /usr/lib/libSerialComProxyDll.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC

${OBJECTDIR}/_ext/262068057/MutexGuard.o: ../include/MutexGuard.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/262068057
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/mysql -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/262068057/MutexGuard.o ../include/MutexGuard.cpp

${OBJECTDIR}/_ext/262068057/SysMutex.o: ../include/SysMutex.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/262068057
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/mysql -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/262068057/SysMutex.o ../include/SysMutex.cpp

${OBJECTDIR}/CJZPlatformProxy.o: CJZPlatformProxy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/mysql -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CJZPlatformProxy.o CJZPlatformProxy.cpp

${OBJECTDIR}/Encrypter.o: Encrypter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/mysql -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Encrypter.o Encrypter.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} /usr/lib/libSerialComProxyDll.${CND_DLIB_EXT}

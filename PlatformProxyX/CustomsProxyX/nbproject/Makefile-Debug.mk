...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /usr/lib/libCustomsProxyX.${CND_DLIB_EXT}

/usr/lib/libCustomsProxyX.${CND_DLIB_EXT}: /usr/lib/mysql/libmysqlclient_r.so

/usr/lib/libCustomsProxyX.${CND_DLIB_EXT}: ${OBJECTFILES}
	${MKDIR} -p /usr/lib
	${LINK.cc} -o /usr/lib/libCustomsProxyX.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} /usr/lib/libCustomsProxyX.${CND_DLIB_EXT}

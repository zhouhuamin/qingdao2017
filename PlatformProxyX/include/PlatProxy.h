...
public:
    ...
    virtual int RecordUploadData(CppMySQL3DB* pDatabase, char* pData, int nLen,int nIsRegather=0)
    {  
        return 0;
    }
    ...
    virtual int PackUploadDataProxy(char* szPlatName, char* pData, int nLen, char* szPackedData, int& nPacketDataLen)
    {
        return 0;
    }
};

...
//            , ic_ex_data);
    ...
    // 2016-5-30
    sprintf(chQuerySQL, "INSERT INTO T_GATHERINFO_IC(SEQUENCE_NO,GATHER_AREA,CHANNEL_NO,DR_IC_NO,\
                        IC_DR_CUSTOMS_NO,IC_CO_CUSTOMS_NO,IC_BILL_NO,IC_GROSS_WT,IC_VE_CUSTOMS_NO,\
                        IC_VE_NAME,IC_CONTA_ID,IC_ESEAL_ID,IC_BUSS_TYPE,IC_EX_DATA) \
...
//            , weight);
    ...
    sprintf(chQuerySQL, "INSERT INTO T_GATHERINFO_WEIGHT(SEQUENCE_NO,GATHER_AREA,CHANNEL_NO,PASS_TIME,GROSS_WT) \
             VALUES('%s','%s','%s','%s','%s')"
            , seq_no
            , area_id
            , chnl_no
